...
class Associations extends ConsumerStatefulWidget {
  const Associations({Key? key}) : super(key: key);

  @override
  ConsumerState<Associations> createState() => _AssociationsState();
}

class _AssociationsState extends ConsumerState<Associations> {
  String token = '';
  ...
  TextEditingController card_product_token = TextEditingController();
  ...
  Future post() async {
    ...
    var response = await http.post(
      Uri.parse(baseUrl),
      body: ({
        "token": product_category.text,
        "name": name.text,
        "card_product_token": card_product_token.text,
      }),
      headers: {
